...
The main file to be considered here is the Notebook wrangle_act.ipynb, the wrangling and analysis happens here. 
Here Python was used, with the following libraries :
* Pandas
* Numpy
* Matplotlib
* Tweepy
...
# Credits
* Udacity - for teaching Data Wrangling and providing image_predictions
* WeRateDogs - for providing their Twitter archive
